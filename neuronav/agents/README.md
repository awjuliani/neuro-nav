...
| DistQ | Q(s, a, c) | one-step temporal difference | [Dabney et al., 2019](https://www.nature.com/articles/s41586-019-1924-6) | A distributional q-learning algorithm which uses separate learning rates for optimistic and pessimistic units. | [Code](./dist_agents.py) |
